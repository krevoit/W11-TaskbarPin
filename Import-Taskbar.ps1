...
Version 2, runs everytime a user logs in and checks if the taskbar have been applied before.
...
Function CleanUpAndExit() {
    ...
    $StoreResults = "\THGS\Taskbar" # Change this to something that fits your organization.
